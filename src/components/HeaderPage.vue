            ...
            <div class="w-[70%] flex flex-col lg:flex-row items-center justify-between mt-[200px]">
                ...
                <div class="">
                    ...
                    <div class="primary-center h-70 p-8">
                        <p class="text-center lg:text-end text-lg text-mutedForeground desktop:w-180">Développeur créatif, je conçois des expériences numériques minimalistes et innovantes en appliquant mes compétences pour résoudre les problématiques avec rigueur et créer des solutions à forte valeur ajoutée</p>
                    </div>
                </div>
